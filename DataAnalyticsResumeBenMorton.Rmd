...
- <i class="fa fa-envelope"></i>benjamin.morton@tufts.edu
- <i class="fa fa-github"></i> [github.com/BMorton14/](https://github.com/BMorton14/)
...
-Good at following along with the supplemental lecture
